// 1. MATCH THE NAMESPACE FROM BUILD.GRADLE
...
// 2. Ensure R is recognized (It is auto-generated in this package now)
...
class MessageAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == VIEW_TYPE_USER) {
            // These R.layout references should turn purple/valid now
